...
SECRET_KEY = '+v=l&@g#+=+5m15=sv5#bbx@j85ieqifljn)t@#5hb)a3q8(-s'
...
STRIPE_PUBLISHABLE = os.getenv('STRIPE_PUBLISHABLE', 'pk_test_vddfABYzla7vGc4ps1OFsxVI')

STRIPE_SECRET = os.getenv('STRIPE_SECRET', 'sk_test_UA9meAareMZzncPg8vrHjybU')
